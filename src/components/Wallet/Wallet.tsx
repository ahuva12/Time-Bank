...
const Wallet: React.FC<WalletProps> = ({
  ...
  return (
    <div
      className={`${styles.card} ${styles.wallet}`}
    ...
    >
      ...
      <p className={styles.title}><strong>הארנק שלך</strong></p>
      <div className={styles.info}>
        <p>שעות שתרמת: {hoursGiven}</p>
        <p>שעות שניצלת: {hoursReceived}</p>
        <p><strong>יתרת שעות: {hoursRemaining}</strong></p>
      </div>
    </div>
  );
};
