  ...
  return (
    <div className={styles.container}>
      ...
      <section className={styles.section}>
        ...
        <p>
          בנק זמן הוא מערכת שמאפשרת לאנשים להעניק שירותים אחד לשני, כאשר כל שעה
          של זמן היא שוות ערך, ללא קשר לסוג השירות. כל שעה שאתה מקדיש למישהו
          אחר, ניתן להמיר לשעה של עזרה או שירות ממישהו אחר בתמורה. במקום להשתמש
          בכסף כיחידת ערך, בבנק הזמן אנו משתמשים בשעות. כל שעה של עבודה נחשבת
          שווה לשעה של שירות אחר.
        </p>
      </section>
